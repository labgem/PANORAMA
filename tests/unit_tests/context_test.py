...
def create_r_graph_with_akin_mapping(akin_mapping):
    ...
    r_edges = [(families["R1"], families["R2"]), 
               (families["R2"], families["R3"]), 
               (families["R2"], families.get("R4", MockGeneFamily("R4", akin_mapping.get("R4", 200)))), 
               (families.get("R4", MockGeneFamily("R4", akin_mapping.get("R4", 200))), families.get("R6", MockGeneFamily("R6", akin_mapping.get("R6", 6)))),
               (families["R3"], families["R5"]), 
               (families.get("R6", MockGeneFamily("R6", akin_mapping.get("R6", 6))), families["R5"]), 
...
def create_g_graph_with_akin_mapping(akin_mapping):
    ...
    g_edges = [(families["G1"], families.get("G2", MockGeneFamily("G2", akin_mapping.get("G2", 100)))), 
               (families.get("G2", MockGeneFamily("G2", akin_mapping.get("G2", 100))), families["G3"]),
...
def test_get_conserved_genomics_contexts(r_graph, g_graph):
    ...
    expected_results = [({r["R1"], r["R2"], r["R3"]}, {g["G4"], g["G5"], g["G3"]}), 
                        ({r["R7"]}, {g["G6"]}),
                        ({r["R5"]}, {g["G1"]})]
