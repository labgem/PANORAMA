...
def check_parameters(args: argparse.Namespace) -> None:
    ...
    def check_coverage_parameters():
        ...
        if args.coverage != (None, None):
            args.coverage = (
                restricted_float(args.coverage[0]),
                restricted_float(args.coverage[1]),
            )
...
def launch(args: argparse.Namespace):
    ...
    if args.hmm:
        ...
        create_hmm_list_file(
            ...
            hmm_coverage=args.hmm_coverage,
...
def parser_utils(parser: argparse.ArgumentParser):
    ...
    translate = parser.add_argument_group(
        title="Translate arguments",
